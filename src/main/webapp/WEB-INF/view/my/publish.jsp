...
<body>
	...
	<form id="form1">
		<div class="form-group">
			...
			<input type="text" name="title" class="form-control form-control-sm col-sm-10">
		</div>
		...
		<div class="form-group form-inline">
			...
			<label for="title" style="padding-left: 20px">所属分类:</label>
