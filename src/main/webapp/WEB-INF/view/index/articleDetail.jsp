		...
		<div class="row" style="margin-top: 10px">
			...
			<div class="col-md-7">
				...
				<c:if test="${collect!=null}">
					<button type="button" onclick="deleteCollect(-1)" class="btn btn-link">★&nbsp;  取消收藏</button>
				</c:if>
				<c:if test="${collect==null}">
					<button type="button" onclick="collect(1)" class="btn btn-link">☆&nbsp;  收藏</button>
				</c:if>
				<hr>
				${article.content}
				<hr>
